package com.ibratclub.bot.constant;

/**
 * @author Malikov Azizjon  *  17.01.2023  *  0:00   *  IbratClub
 */
public interface ConstantEn {

    String START = "Hello! Welcome to our bot! \n" +
            "First select the service language:\n";
    String BUTTON = "English \uD83C\uDDEC\uD83C\uDDE7";
    String CONTACT_BUTTON = "Share contact \uD83D\uDCDE";
    String CONTACT = "Enter your phone number\n" +
            " \n" +
